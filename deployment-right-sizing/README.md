...
Divides P95 across Pod-level P95 CPU values by average CPU request. `clamp_min` prevents division by values below `0.001` cores. Thresholds: yellow below 20%, green from 20% to below 80%, yellow from 80% to below 105%, red from 105%.
...
Divides the Deployment's highest P99 memory usage by average memory request. `clamp_min` prevents division by values below 1 byte. Thresholds: yellow below 20%, green from 20% to below 80%, yellow from 80% to below 105%, red from 105%.
...
- Yellow: below 20%, possible over-requesting.
- Green: 20% to below 80%.
- Yellow: 80% to below 105%, low headroom warning.
- Red: 105% and above, usage exceeds request.
